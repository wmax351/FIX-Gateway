    ...
    def run(self):
        while not self.getout:
            if(self.model == 2004):
                ...
                cht1 = int((int.from_bytes(s[2:4], "big")))
                cht2 = int((int.from_bytes(s[4:6], "big")))
                egt1 = int((int.from_bytes(s[6:8], "big")))
                egt2 = int((int.from_bytes(s[8:10], "big")))
                ...
                if (oat > 127):
                    oat -= 256
                oat = int((oat))
                coolant = int((int.from_bytes(s[21:23], "big")))
                oilt = int((int.from_bytes(s[23:25], "big")))
                oilp = s[25]
                ...
                cht1 = int((int.from_bytes(s[2:4], "big")))
                cht2 = int((int.from_bytes(s[4:6], "big")))
                cht3 = int((int.from_bytes(s[6:8], "big")))
                cht4 = int((int.from_bytes(s[8:10], "big")))
                cht5 = int((int.from_bytes(s[10:12], "big")))
                cht6 = int((int.from_bytes(s[12:14], "big")))
                egt1 = int((int.from_bytes(s[14:16], "big")))
                egt2 = int((int.from_bytes(s[16:18], "big")))
                egt3 = int((int.from_bytes(s[18:20], "big")))
                egt4 = int((int.from_bytes(s[20:22], "big")))
                egt5 = int((int.from_bytes(s[22:24], "big")))
                egt6 = int((int.from_bytes(s[24:26], "big")))
                ...
                self.parent.db_write("FUELP1", aux2)
